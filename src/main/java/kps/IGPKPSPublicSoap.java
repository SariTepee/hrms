...
public class IGPKPSPublicSoap
{
    ...
    public IGPKPSPublicSoap(){}

    public IGPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IGPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IGPExtendedSoapSerializationEnvelope envelope= new IGPExtendedSoapSerializationEnvelope(IGPExtendedSoapSerializationEnvelope.VER11);
