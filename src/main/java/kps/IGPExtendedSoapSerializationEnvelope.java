...
public class IGPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IGPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IGPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IGPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IGPDateTimeConverter dateTimeConverter = new IGPStandardDateTimeConverter();

    public IGPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IGPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IGPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IGPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IGPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IGPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
